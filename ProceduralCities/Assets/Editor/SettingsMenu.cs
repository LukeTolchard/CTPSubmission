...
namespace CityGenerator 
{
    ...
    public class SettingsMenu : EditorWindow 
    {
        ...
        private void Highway() 
        {
            ...
            GUILayout.BeginArea(new Rect((Screen.width / 2) - 105, 30, 210, 160));
                GUILayout.Label("Highway Settings", style);
                ...
                EditorGUILayout.BeginHorizontal();
                    settings.H_laserDistance = VariableFloatField("Section Length", "The Length of new generated highway section", settings.H_laserDistance,10,50);
            ...
            GUILayout.BeginArea(new Rect((Screen.width / 2) - 65, 180, 200, 100));
                EditorGUILayout.BeginHorizontal();
            ...
            if (settings.H_canBranch) {
                ...
                GUILayout.BeginArea(new Rect((Screen.width / 2) - 105, 240, 210, 165));
        ...
        private void MainRoad() {
            ...
            GUILayout.BeginArea(new Rect((Screen.width / 2) - 105, 30, 210, 160));
                ...
                EditorGUILayout.BeginHorizontal();
                    settings.MR_MinRoadLength = VariableIntField("Min Length", "Minimum length of a new road.", settings.MR_MinRoadLength, 25);
                    settings.MR_MaxRoadLength = VariableIntField("Max Length", "Maximum length of a new road.", settings.MR_MaxRoadLength, 50);
                EditorGUILayout.EndHorizontal();

 

                EditorGUILayout.BeginHorizontal();
                    settings.MR_laserDistance = VariableFloatField("Section Length", "The distance around the last road checked for the new road location", settings.MR_laserDistance, 10, 50);
            ...
            GUILayout.BeginArea(new Rect((Screen.width / 2) - 50, 200, 200, 100));
            ...
            if (settings.MR_canBranch) {
                ...
                GUILayout.BeginArea(new Rect((Screen.width / 2) - 110, 235, 220, 165));
                GUILayout.Label("Branch Settings", style);
        ...
        private void Street() {
            ...
            GUILayout.BeginArea(new Rect((Screen.width / 2) - 105, 30, 210, 160));
                ...
                EditorGUILayout.BeginHorizontal();
                    settings.R_minPopulation = VariableFloatField("Minimal pop", "Minimal population for a road to spawn", settings.R_minPopulation, 0, 1);
                    settings.R_laserDistance = VariableFloatField("Road Length", "The Length of new generated road section", settings.R_laserDistance, 10, 50);
                EditorGUILayout.EndHorizontal();
            ...
            GUILayout.BeginArea(new Rect((Screen.width / 2) - 105, 180, 210, 150));
            ...
            GUILayout.BeginArea(new Rect((Screen.width / 2) - 50, 320, 200, 100));
            EditorGUILayout.BeginHorizontal();
            ...
            if (settings.buildBuildings) {
                ...
                GUILayout.BeginArea(new Rect((Screen.width / 2) - 105, 375, 210, 120));
                EditorGUILayout.BeginHorizontal();
                settings.homeThreshold = VariableFloatField("Tower Threshold", "The minimum population needed for a tower", settings.homeThreshold, 0, 1);
                settings.pointTowerThreshold = VariableFloatField("P-twr Threshold", "The minimum population needed for a point-tower", settings.pointTowerThreshold, 0, 1);
                EditorGUILayout.EndHorizontal();
                GUILayout.EndArea();
                GUILayout.Space(40);
            }
        ...
        private void Constraints()
        {
            ...
            //GUILayout.BeginArea(new Rect((Screen.width / 2) - 105, 200, 210, 150));
            //GUILayout.Label("Presets", style);

            //EditorGUILayout.BeginHorizontal();
            //settings.MR_canBranch = VariableBoolField("Rich", settings.MR_canBranch);
            //EditorGUILayout.EndHorizontal();
            //GUILayout.EndArea();
        ...
        private static int VariableIntField(string name, string tooltip, int value, int maxRecommend) {
            ...
            if (value > maxRecommend) {
                ...
                tooltip = "Max value of " + maxRecommend + " is recommended, you may encounter strange generations.";
            }
        ...
        private static float VariableFloatField(string name, string tooltip, float value, int minRecommend, int maxRecommend) {
            GUILayout.BeginVertical();
            var style = new GUIStyle(GUI.skin.label) {
                alignment = TextAnchor.UpperCenter,
                fixedWidth = 100
            ...
            if (value > maxRecommend || value < minRecommend)
            {
                style.normal.textColor = Color.red;
                tooltip = "A value between " + minRecommend + " and " + maxRecommend + " is recommended, you may encounter strange generations.";
            }
